                ...
                <form method="POST" action="/login" class="flex flex-col gap-4">
                    ...
                    <div class="form-control relative">
                        ...
                        <div class="relative">
                            ...
                            <button type="button" onclick="togglePassword()" class="absolute inset-y-0 right-0 pr-3 flex items-center text-base-content/50 hover:text-base-content">
                                ...
                                <svg id="eye-slash-icon" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 hidden" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.29 3.29m0 0a9.953 9.953 0 013.85-2.096m1.077-.206c.33-.064.666-.1.996-.1 4.478 0 8.268 2.943 9.542 7a10.025 10.025 0 01-2.437 3.518" />
                                </svg>
                            </button>
                        </div>
                    </div>
